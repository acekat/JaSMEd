...
\emph{structure} : construction et maintenance de la structure musicale.\\[0.4cm]
\emph{player} : lecture de la structure musicale à l'aide de la bibliothèque Audiolib.\\[0.4cm]
\emph{communicator} : communication avec le serveur. Ce module écoute et émet sur la socket liée au serveur. Il récupère les messages diffusés par ce dernier, et lui fait suivre les messages locaux.\\[0.4cm]
