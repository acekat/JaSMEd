...
\lstdefinestyle{SolarizedLight}{
	...
	commentstyle=\color{base0}\itshape,
...
(function(arg) {
  ...
  var x; 				// privé
  arg.hello = 'hello'; 	// publique -> accessible en dehors de la fonction.
...
\paragraph{Organisation du code client}~\\
...
\paragraph{Lecture de la structure musicale}~\\
